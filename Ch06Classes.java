...
public class Ch06Classes {
    ...
    static void shipParcel() {
        ...
        parcel.addHistory(parcel.status, "출고", readLine("출고일: "));
        parcel.status = "출고";
    ...
    static void cancelParcel() {
        ...
        parcel.addHistory(parcel.status, "취소", readLine("취소일: "));
        parcel.status = "취소";
    ...
    static int calculateFee(Parcel parcel) {
        ...
        if (parcel.deliveryType.equals("특급")) {
            fee += 2000;
        } else if (parcel.deliveryType.equals("냉장")) {
            fee += 4000;
        } else if (parcel.deliveryType.equals("해외")) {
            fee += 15000;
        }
...
class Parcel {
    ...
    Parcel(String trackingNumber, String receiverName, String receiverPhoneNumber,
           String destination, String deliveryType, int weight, String registeredDate) {
