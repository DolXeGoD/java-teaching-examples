...
public class Ch08Repository {
    ...
    static void registerParcel() {
        ...
        if (registerType == 1) {
            parcelService.registerSimple(trackingNumber, receiverName, receiverPhoneNumber,
        ...
        if (registerType == 2) {
            ...
            parcelService.register(trackingNumber, receiverName, receiverPhoneNumber,
    ...
    static void changeStatus(ParcelStatus afterParcelStatus, String dateMessage) {
        ...
        String historyChangedDate = readLine(dateMessage);
        parcelService.changeStatus(trackingNumber, afterParcelStatus, historyChangedDate);
    }
